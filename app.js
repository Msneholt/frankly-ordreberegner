    ...
    <div class="workspace">
      <section class="card form-card" aria-labelledby="form-title">
        <div class="identity-grid">
          ...
          <label class="field"><span>Postnummer</span><input id="postalCode" type="text" inputmode="numeric" maxlength="4" placeholder="123" autocomplete="postal-code"></label>
  ...
  <script>
    (function(){
      ...
      function renderCleanQuote(state,selected,deliveryText,totalText,totalVatText){
        ...
        var cleanNext=document.getElementById("cleanQuoteNext");cleanNext.hidden=!state.priceGap.available;if(state.priceGap.available){document.getElementById("cleanQuoteNextText").textContent="Bestil "+integers.format(state.priceGap.extraProducts)+" produkter yderligere og få en lavere pris pr. produkt.";}
